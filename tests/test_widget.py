...
from src.widget import get_mask_card_or_account, get_date_string

@pytest.mark.parametrize("numbers, result", [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
...
@pytest.mark.parametrize("date, date_string", [("2018-07-11T02:26:18.671407", "11.07.2018"),
